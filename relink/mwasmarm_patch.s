...
.incbin "mwasmarm.exe", text_off, patch_fs_1

    xor eax, eax
    push eax

.fill patch_fs_1.end - (. - pe_text), 1, 0x90
.incbin "mwasmarm.exe", text_off + patch_fs_1.end, patch_fs_2 - patch_fs_1.end

    xor eax, eax
    push eax

.fill patch_fs_2.end - (. - pe_text), 1, 0x90
.incbin "mwasmarm.exe", text_off + patch_fs_2.end, patch_init_args - patch_fs_2.end
...
.incbin "mwasmarm.exe", text_off + patch_init_args.end, text_len - patch_init_args.end
